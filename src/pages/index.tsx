      ...
      <div className='flex h-[calc(100vh-4rem)] flex-col items-center justify-center bg-gradient-to-br from-rose-500 to-purple-600 '>
        {!sessionData && (
          <button
            ...
            className='rounded-full bg-black/10 px-10 py-3 font-semibold no-underline transition hover:bg-black/20 bg-gradient-to-r from-fuchsia-600 to-purple-600 text-[#ededed] border-2 border-[#cdcdcd] flex items-center justify-between gap-3'>
